...
# ====================
  # NPM
  alias ias="npm install && atom . && npm start"
...
# update heroku db instructor app
function hdb {
  heroku pg:backups:capture --app flatiron-instructor-app
  rm latest.dump
  heroku pg:backups:download --app flatiron-instructor-app
  rake local_setup:setup[flatironschool]
}
